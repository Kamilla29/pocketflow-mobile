...
Runtime screenshots and demo video should only be added from a verified simulator/device capture so the repository never presents generated mockups as application evidence.
